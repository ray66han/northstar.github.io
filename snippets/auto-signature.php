<!-- auto-signature main body start from here -->
            ...
            <div class="card-body">
                ...
                <div class="options-grp">
                    ...
                    <div class="form-group signature-div">
                        <p class="danger-info-txt"><span class="exclamation-mark">&#33;</span><span class="circle"></span> Please enter your name above to see result</p>
...
<!-- /auto-signature main body ends here -->